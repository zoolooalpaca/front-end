<template>
  <!--  <div class="bg-img block p-6 border-2 border-gray-600 rounded"-->
  <!--       v-bind:style="{ 'background-image': 'url(' + image + ')' }">-->
  <!--    <p class="title-large text-center">{{ name }}</p>-->
  <!--  </div>-->
  ...
  <div
      ...
      border-radius: 20px;">
    <div class="mask food-category-chip p-5" style="background-color: rgba(0, 0, 0, 0.5);">
